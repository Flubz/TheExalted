...
public class DistEffect : MonoBehaviour
{
	...
	void Start ()
	{
		...
		{
			Transform t = Instantiate (_distEffect, transform.position + ((Vector3.right) * _offsets * i), Quaternion.identity, transform) as Transform;
